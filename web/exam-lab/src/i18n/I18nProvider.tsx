...
//
// Why the gate: this app is a dynamic SPA behind a login guard, so the
// prerendered HTML carrying text buys us nothing — and it can't carry the
// user's language anyway, which is known only in the browser (localStorage /
// navigator). Rendering children on the server would either bake in the
// fallback language (hydration mismatch: with streaming SSR the layout's
...
// language (the SSR'd title from app/layout.tsx is the fallback language).
